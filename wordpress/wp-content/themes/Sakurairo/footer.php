			...
			<div class="footer-device Ubuntu-font">
					...
					<span style="color: #b9b9b9;">
						...
						<?php if (iro_opt('footer_upyun', 'true')): ?>
							<br>本网站由 <a href="https://www.upyun.com/?utm_source=lianmeng&utm_medium=referral" target="_blank"> <img alt="upyun-logo" src="./wp-content/themes/Sakurairo/upyun.png"  style="display:inline-block;vertical-align:middle;width:60px;height:30px;"/></a> 提供CDN加速/云存储服务
                        <?php endif; ?><br>
                        Powered By <a href='https://wordpress.org' rel="noopener" id="site-info">WordPress</a> | Theme By <a href='https://github.com/mirai-mamori/Sakurairo' rel="noopener" id="site-info">Sakurairo</a>
					</span>
			</div>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
