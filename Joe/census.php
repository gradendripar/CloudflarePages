...
<head>
    ...
    <link rel="stylesheet" href="<?php _CdnUrl4Themes('assets/css/joe.census.min.css'); ?>">
    <script src=<?php echo $JsdelivrPath ?>/npm/echarts@5.1.1/dist/echarts.min.js></script>
    <script src=<?php _CdnUrl4Themes('assets/js/joe.census.min.js'); ?>></script>
</head>
