...
<head>
    ...
    <link rel="stylesheet" href="<?php _CdnUrl4Themes('library/guidang/guidang.css'); ?>">
    <script src="<?php _CdnUrl4Themes('library/guidang/guidang.js'); ?>"></script>
    <script src="<?php _CdnUrl4Themes('assets/js/joe.post_page.min.js?v=20210430'); ?>"></script>
</head>
<body>
    <div id="Joe">
