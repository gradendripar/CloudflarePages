...
<head>
    ...
    <link rel="stylesheet" href="<?php _CdnUrl4Themes('assets/css/joe.video.min.css'); ?>">
    <script src="<?php _CdnUrl4Themes('assets/js/joe.video.min.js'); ?>"></script>
</head>
            ...
            <div class="joe_main">
                <?php if (isset($_GET['vod_id'])) : ?>
                    ...
                    <div class="joe_video__player joe_video__contain">
                        ...
                        <iframe allowfullscreen="true" class="joe_video__player-play" data-player="<?php $this->options->JCustomPlayer ? $this->options->JCustomPlayer() : Helper::options()->themeUrl('library/player.php?JsdelivrPath='.$JsdelivrPath.'&url=') ?>"></iframe>
                    </div>
                <?php else : ?>
