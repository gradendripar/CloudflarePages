...
<head>
    ...
    <script src=<?php echo $JsdelivrPath ?>/npm/draggabilly@2.3.0/dist/draggabilly.pkgd.js></script>
    <script src="<?php _CdnUrl4Themes('assets/js/joe.leaving.min.js'); ?>"></script>
</head>
