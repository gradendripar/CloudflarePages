...
<header class="joe_header <?php echo $this->is('post') ? 'current' : '' ?>">
    <div class="joe_header__above">
        ...
        <?php if (Helper::options()->RainbowBar == 'on') : ?>
            <div id="top-img"></div>
        <?php endif; ?>
        ...
        <div class="joe_container">
            ...
            <a title="<?php $this->options->title(); ?>" class="joe_header__above-logo <?php if(Helper::options()->Logo4SaoGuang == 'on') echo 'sg_texiao'  ?>" href="<?php $this->options->siteUrl(); ?>">
    ...
    <?php
        if ($this->options->JHeaderCounter == 'on') {
            ?>
            ...
            <ul class="joe_header__slideout-count">
                <div id="lovexhj" style="width: 100%; height: 100%; text-align: center; font-size: 1rem;">
                    <div id="lovexhjImage" style="width: 220px; margin: 0 auto;">
                        ...
                        <!-- 中间的图片 -->
                        <img src="https://img.zhinianboke.com/img/4691" alt="love" style="width: 60px; border-radius: 50%;">
                        <!-- 右边的头像 -->
    ...
    <!-- 弹幕 -->
    <?php if ($this->options->JBarragerStatus === 'on') : ?>
        <script src="<?php _CdnUrl4Themes('library/joe.barrager/joe.barrager.js'); ?>"></script>
    <?php endif; ?>
</header>