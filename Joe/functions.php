...
?>
    <?php 
        ...
        $ZhinianSite = Helper::options()->ZhinianSite;
        if(empty($ZhinianSite)) {
            $ZhinianSite = 'zhinianboke.com';
        }
    ?>
    
    <script>
        var ZhinianSite = '<?php echo $ZhinianSite; ?>';
        var blogTitle = '<?php Helper::options()->title() ?>';
        var shareStaticFile = '<?php Helper::options()->ShareStaticFile() ?>';
        var cdnThemeUrl = '<?php Helper::options()->themeUrl() ?>';
    </script>
    
    <link rel="stylesheet" href="<?php _CdnUrl4Themes('typecho/config/css/joe.config.min.css'); ?>">
    <link rel="stylesheet" href="<?php _CdnUrl4Themes('typecho/config/css/back.custom.css'); ?>">
    <style>
	...
	<script src="<?php _CdnUrl4Themes('typecho/config/js/joe.config.min.js'); ?>"></script>
    <script src="<?php _CdnUrl4Themes('assets/js/custom.js?v=3.0.4'); ?>"></script>
    <div class="joe_config">
        <div>
            <div class="joe_config__aside">
                <div class="logo">Joe <?php echo _getVersion() ?>
                    <p style="font-size: 5px;" id="zhinianblog_version"><?php echo _get_Zhinian_Version(); ?></p>
                </div>
                <ul class="tabs">
                    ...
                    <li class="item" data-current="joe_custom1">附加设置</li>
                    <li class="item" data-current="joe_ffyd">付费阅读</li>
                </ul>
                <?php require_once('core/backup.php'); ?>
            </div>
        </div>
        <div class="joe_config__notice">请求数据中...</div>
        <div class="joe_config__dingyue joe_config__custom" style="display: none;"><iframe src="https://dy.<?php echo $ZhinianSite; ?>/dy/dingyue/DingYue005/init"  width="100%" height="750px" scrolling="auto" style="border: medium none;"></iframe></div>
        <div class="joe_config__caiji joe_config__custom" style="display: none;"><iframe src="https://dy.<?php echo $ZhinianSite; ?>/system/caiji/CaiJi001/init"  width="100%" height="750px" scrolling="auto" style="border: medium none;"></iframe></div>
        <div class="joe_config__link joe_config__custom" style="display: none;"><iframe src="https://dy.<?php echo $ZhinianSite; ?>/frdlk/friends/AutoFriendsSumit002/init" width="100%" height="750px" scrolling="auto" style="border: medium none;"></iframe></div>
        <div class="joe_config__themeUpdate">
            <h5>请开启插件后使用，插件下载地址：<a href="https://zhinianboke.com/archives/993/">https://zhinianboke.com/archives/993/</a></h5>
            ...
            <p style="margin-left: 20px;margin-top: 20px;">
                ...
                <select id="AutoUpdateTheme_downLoadUrl" style="margin-left: 8px;width: 186px;height: 32px">
                    <option value="http://download.<?php echo $ZhinianSite; ?>/themes/Joe-master_zhinian.zip">执念博客同款</option>
                    <option value="http://download.<?php echo $ZhinianSite; ?>/themes/Joe-master.zip">Joe官方主题</option>
                </select>
            </p>
            <button id="AutoUpdateTheme_submit" style="margin-left: 100px;margin-top: 20px; width: 120px;" class="btn primary">开始更新</button>
        </div>
        <div class="joe_config__query joe_config__custom" style="display: none;"><iframe src="https://dy.<?php echo $ZhinianSite; ?>/blog/theme/query/ThemeQuery001/init" width="100%" height="750px" scrolling="auto" style="border: medium none;"></iframe></div>
    <?php
    ...
    $JLive2d = new Typecho_Widget_Helper_Form_Element_Select(
        ...
        array(
            'off' => '关闭（默认）',
            $JsdelivrPath.'/npm/live2d-widget-model-shizuku@1.0.5/assets/shizuku.model.json' => 'shizuku',
            $JsdelivrPath.'/npm/live2d-widget-model-izumi@1.0.5/assets/izumi.model.json' => 'izumi',
            $JsdelivrPath.'/npm/live2d-widget-model-haru@1.0.5/01/assets/haru01.model.json' => 'haru01',
            $JsdelivrPath.'/npm/live2d-widget-model-haru@1.0.5/02/assets/haru02.model.json' => 'haru02',
            $JsdelivrPath.'/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json' => 'wanko',
            $JsdelivrPath.'/npm/live2d-widget-model-hijiki@1.0.5/assets/hijiki.model.json' => 'hijiki',
            $JsdelivrPath.'/npm/live2d-widget-model-koharu@1.0.5/assets/koharu.model.json' => 'koharu',
            $JsdelivrPath.'/npm/live2d-widget-model-z16@1.0.5/assets/z16.model.json' => 'z16',
            $JsdelivrPath.'/npm/live2d-widget-model-haruto@1.0.5/assets/haruto.model.json' => 'haruto',
            $JsdelivrPath.'/npm/live2d-widget-model-tororo@1.0.5/assets/tororo.model.json' => 'tororo',
            $JsdelivrPath.'/npm/live2d-widget-model-chitose@1.0.5/assets/chitose.model.json' => 'chitose',
            $JsdelivrPath.'/npm/live2d-widget-model-miku@1.0.5/assets/miku.model.json' => 'miku',
            $JsdelivrPath.'/npm/live2d-widget-model-epsilon2_1@1.0.5/assets/Epsilon2.1.model.json' => 'Epsilon2.1',
            $JsdelivrPath.'/npm/live2d-widget-model-unitychan@1.0.5/assets/unitychan.model.json' => 'unitychan',
            $JsdelivrPath.'/npm/live2d-widget-model-nico@1.0.5/assets/nico.model.json' => 'nico',
            $JsdelivrPath.'/npm/live2d-widget-model-rem@1.0.1/assets/rem.model.json' => 'rem',
            $JsdelivrPath.'/npm/live2d-widget-model-nito@1.0.5/assets/nito.model.json' => 'nito',
            $JsdelivrPath.'/npm/live2d-widget-model-nipsilon@1.0.5/assets/nipsilon.model.json' => 'nipsilon',
            $JsdelivrPath.'/npm/live2d-widget-model-ni-j@1.0.5/assets/ni-j.model.json' => 'ni-j',
            $JsdelivrPath.'/npm/live2d-widget-model-nietzsche@1.0.5/assets/nietzche.model.json' => 'nietzche',
            $JsdelivrPath.'/npm/live2d-widget-model-platelet@1.1.0/assets/platelet.model.json' => 'platelet',
            $JsdelivrPath.'/npm/live2d-widget-model-isuzu@1.0.4/assets/model.json' => 'isuzu',
            $JsdelivrPath.'/npm/live2d-widget-model-jth@1.0.0/assets/model/katou_01/katou_01.model.json' => 'katou_01',
            $JsdelivrPath.'/npm/live2d-widget-model-mikoto@1.0.0/assets/mikoto.model.json' => 'mikoto',
            $JsdelivrPath.'/npm/live2d-widget-model-mashiro-seifuku@1.0.1/assets/seifuku.model.json' => 'seifuku',
            $JsdelivrPath.'/npm/live2d-widget-model-ichigo@1.0.1/assets/ichigo.model.json' => 'ichigo',
            $JsdelivrPath.'/npm/live2d-widget-model-hk_fos@1.0.0/assets/hk416.model.json' => 'hk416'
        ),
        'off',
    ...
    $JIndex_Ad = new Typecho_Widget_Helper_Form_Element_Textarea(
        ...
        '介绍：请务必填写正确的格式 <br />
         ...
         例如：https://puui.qpic.cn/media_img/lena/PICykqaoi_580_1680/0 || https://baidu.com || 2021-10-10'
    );
    ...
    $JPrismTheme = new Typecho_Widget_Helper_Form_Element_Select(
        'JPrismTheme',
        array(
            $JsdelivrPath.'/npm/prismjs@1.23.0/themes/prism.min.css' => 'prism（默认）',
            $JsdelivrPath.'/npm/prismjs@1.23.0/themes/prism-dark.min.css' => 'prism-dark',
            $JsdelivrPath.'/npm/prismjs@1.23.0/themes/prism-okaidia.min.css' => 'prism-okaidia',
            $JsdelivrPath.'/npm/prismjs@1.23.0/themes/prism-solarizedlight.min.css' => 'prism-solarizedlight',
            $JsdelivrPath.'/npm/prismjs@1.23.0/themes/prism-tomorrow.min.css' => 'prism-tomorrow',
            $JsdelivrPath.'/npm/prismjs@1.23.0/themes/prism-twilight.min.css' => 'prism-twilight',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-a11y-dark.min.css' => 'prism-a11y-dark',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-atom-dark.min.css' => 'prism-atom-dark',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-base16-ateliersulphurpool.light.min.css' => 'prism-base16-ateliersulphurpool.light',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-cb.min.css' => 'prism-cb',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-coldark-cold.min.css' => 'prism-coldark-cold',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-coldark-dark.min.css' => 'prism-coldark-dark',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-darcula.min.css' => 'prism-darcula',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-dracula.min.css' => 'prism-dracula',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-duotone-dark.min.css' => 'prism-duotone-dark',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-duotone-earth.min.css' => 'prism-duotone-earth',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-duotone-forest.min.css' => 'prism-duotone-forest',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-duotone-light.min.css' => 'prism-duotone-light',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-duotone-sea.min.css' => 'prism-duotone-sea',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-duotone-space.min.css' => 'prism-duotone-space',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-ghcolors.min.css' => 'prism-ghcolors',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-gruvbox-dark.min.css' => 'prism-gruvbox-dark',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-hopscotch.min.css' => 'prism-hopscotch',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-lucario.min.css' => 'prism-lucario',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-material-dark.min.css' => 'prism-material-dark',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-material-light.min.css' => 'prism-material-light',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-material-oceanic.min.css' => 'prism-material-oceanic',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-night-owl.min.css' => 'prism-night-owl',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-nord.min.css' => 'prism-nord',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-pojoaque.min.css' => 'prism-pojoaque',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-shades-of-purple.min.css' => 'prism-shades-of-purple',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-synthwave84.min.css' => 'prism-synthwave84',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-vs.min.css' => 'prism-vs',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-vsc-dark-plus.min.css' => 'prism-vsc-dark-plus',
            $JsdelivrPath.'/npm/prism-themes@1.7.0/themes/prism-xonokai.min.css' => 'prism-xonokai',
            $JsdelivrPath.'/npm/prism-theme-one-light-dark@1.0.4/prism-onelight.min.css' => 'prism-onelight',
            $JsdelivrPath.'/npm/prism-theme-one-light-dark@1.0.4/prism-onedark.min.css' => 'prism-onedark',
            $JsdelivrPath.'/npm/prism-theme-one-dark@1.0.0/prism-onedark.min.css' => 'prism-onedark2',
        ),
        $JsdelivrPath.'/npm/prismjs@1.23.0/themes/prism.min.css',
        '选择一款您喜欢的代码高亮样式',
        '介绍：用于修改代码块的高亮风格 <br>
