...
<html lang="zh-CN">
<?php 
    $JsdelivrPath = $_GET['JsdelivrPath'];
...
<body>
    <div id="dplayer"></div>
    <script src=<?php echo $JsdelivrPath ?>/npm/hls.js@0.14.16/dist/hls.min.js></script>
    <script src=<?php echo $JsdelivrPath ?>/npm/dplayer@1.26.0/dist/DPlayer.min.js></script>
    <script>
        new DPlayer({
