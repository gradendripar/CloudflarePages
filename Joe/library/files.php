...
class config
{
  ...
  function __construct($is_doc = false)
  {
    ...
    // CDN assets
    self::$assets = self::$prod ? $JsdelivrPath.'/npm/files.photo.gallery@' . self::$version . '/' : '';
...
if (post('action')) {
  ...
  if ($action === 'dirs') {
    ...
    $file = $JsdelivrPath.'/npm/files.photo.gallery' . ($version ? '@' . $version : '') . '/index.php';
  ...
  ?>
    ...
    <html<?php echo ' class="menu-' . ($menu_enabled ? 'enabled' : 'disabled sidebar-closed') . '"'; ?>>
      ...
      <head>
        ...
        <link rel="stylesheet" href=<?php echo $JsdelivrPath ?>/npm/photoswipe@4.1.3/dist/photoswipe.css>
        <link href="<?php echo config::$assets ?>css/files.css" rel="stylesheet">
        <?php custom_script('css'); ?>
      </head>
      ...
      <body class="body-loading">
        ...
        <!-- Javascript -->
        <script src=<?php echo $JsdelivrPath ?>/npm/animejs@3.2.0/lib/anime.min.js></script>
        <script src=<?php echo $JsdelivrPath ?>/npm/list.js@1.5.0/dist/list.min.js></script>
        <script src=<?php echo $JsdelivrPath ?>/npm/yall-js@3.2.0/dist/yall.min.js></script>
        <script src=<?php echo $JsdelivrPath ?>/npm/filesize@6.1.0/lib/filesize.min.js></script>
        <script src=<?php echo $JsdelivrPath ?>/npm/photoswipe@4.1.3/dist/photoswipe.js></script>
        <script src=<?php echo $JsdelivrPath ?>/npm/screenfull@5.0.2/dist/screenfull.min.js></script>
        <script src=<?php echo $JsdelivrPath ?>/npm/dayjs@1.8.34/dayjs.min.js></script>
        <script src=<?php echo $JsdelivrPath ?>/npm/dayjs@1.8.34/plugin/localizedFormat.js></script>
        <script src=<?php echo $JsdelivrPath ?>/npm/dayjs@1.8.34/plugin/relativeTime.js></script>
        <script src=<?php echo $JsdelivrPath ?>/npm/bootstrap@5.0.0-alpha1/dist/js/bootstrap.min.js></script>
        <script>
          var _c = <?php echo json_encode($json_config, JSON_PRETTY_PRINT); ?>;
          var CodeMirror = {};
        </script>
        <script src=<?php echo $JsdelivrPath ?>/npm/codemirror@5.57.0/mode/meta.js></script>
        <!-- custom -->
