...
<head>
    ...
    <link rel="stylesheet" href="<?php _CdnUrl4Themes('assets/css/joe.archive.min.css'); ?>">
    <script src="<?php _CdnUrl4Themes('assets/js/joe.archive.min.js'); ?>"></script>
</head>
                            ...
                            <?php while ($this->next()) : ?>
                                <?php if ($this->fields->mode === "default" || !$this->fields->mode) : ?>
                                    <li class="joe_list__item wow default">
                                        <div class="line"></div>
                                        <a href="<?php $this->permalink() ?>" class="thumbnail" title="<?php $this->title() ?>" target="<?php $this->options->JessayTarget() ?>" rel="noopener noreferrer">
                                        ...
                                        <div class="information">
                                            <a href="<?php $this->permalink() ?>" class="title" title="<?php $this->title() ?>" target="<?php $this->options->JessayTarget() ?>" rel="noopener noreferrer">
                                                <?php $this->title() ?>
                                            </a>
                                            <a class="abstract" href="<?php $this->permalink() ?>" title="文章摘要" target="<?php $this->options->JessayTarget() ?>" rel="noopener noreferrer"><?php _getAbstract($this) ?></a>
                                            <div class="meta">
                                                <ul class="items">
