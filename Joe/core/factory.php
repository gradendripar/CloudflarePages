...
?>
        ...
        <link rel="stylesheet" href=<?php echo $JsdelivrPath ?>/npm/prism-theme-one-light-dark@1.0.4/prism-onedark.min.css>
        <link rel="stylesheet" href="<?php _CdnUrl4Themes('typecho/write/css/joe.write.min.css'); ?>">
        <script>
            window.JoeConfig = {
                ...
                playerAPI: '<?php Helper::options()->JCustomPlayer ? Helper::options()->JCustomPlayer() : Helper::options()->themeUrl('library/player.php?JsdelivrPath='.$JsdelivrPath.'&url=') ?>',
                ...
                ZhinianSite: '<?php echo $ZhinianSite; ?>'
            }
        </script>
        ...
        <script src="<?php _CdnUrl4Themes('typecho/write/parse/parse.min.js'); ?>"></script>
        <script src="<?php _CdnUrl4Themes('typecho/write/dist/index.bundle.js'); ?>"></script>
        <script src="<?php _CdnUrl4Themes('assets/js/joe.short.min.js'); ?>"></script>
        <script src="<?php _CdnUrl4Themes('assets/js/custom.js?v=2.9.6'); ?>"></script>
<?php
    }
}
